...
def run_sp_data_processing(db_params, environment):
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            statement="UPDATE derived.dim_facility SET facility_name = 'UMOJA FACILITY';"
            write_to_database(environment, cursor, statement)

            environment.log_message(f"Database updated successfully")
