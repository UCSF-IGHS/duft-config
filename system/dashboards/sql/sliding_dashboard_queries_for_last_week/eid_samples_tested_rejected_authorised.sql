SELECT
	...
	ORDER BY CASE
		...
		WHEN 'Sample Rejected' THEN 2
		WHEN 'Sample Tested' THEN 3
...
FROM
	...
	GROUP BY
		d.weekly_start_monday_period) AS SamplesDataAggregates UNPIVOT (value FOR category IN ([Sample Received], [Sample Rejected], [Sample Tested], [Sample Results Dispatched])) AS unpvt
ORDER BY
	week_name ASC,
	sort_order;